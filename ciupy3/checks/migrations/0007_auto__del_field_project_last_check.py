...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.last_check'
        db.delete_column('checks_project', 'last_check_id')

    def backwards(self, orm):
        # Adding field 'Project.last_check'
        db.add_column('checks_project', 'last_check',
                      self.gf('django.db.models.fields.related.OneToOneField')(unique=True, blank=True, null=True, to=orm['checks.Check']),
                      keep_default=False)
